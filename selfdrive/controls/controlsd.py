  ...
  def publish_logs(self, CS, start_time, CC, lac_log):
    ...
    if Params().get_bool('ToyotaSpeedFix'):
      if self.v_cruise_kph != 255:
        controlsState.vCruise = controlsState.vCruise * 1.0330 # Boost the car to encourage driving at the set speed.

    if Params().get_bool('HKGSpeedFix'):
      if self.v_cruise_kph != 255:
        controlsState.vCruise = controlsState.vCruise * 0.99 # Reduce the car to encourage driving at the set speed.

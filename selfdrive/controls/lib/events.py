...
class NoEntryAlert(Alert):
  def __init__(self, alert_text_2, audible_alert=AudibleAlert.none,
    ...
    super().__init__(_("Openpilot Standby"), alert_text_2, AlertStatus.normal,
...
def alca_alert(CP: car.CarParams, sm: messaging.SubMaster, metric: bool) -> Alert:
  return Alert(
    ...
    AlertStatus.normal, AlertSize.mid,
    Priority.LOWER, VisualAlert.none, AudibleAlert.none, 0., .1, .1, alert_rate=0.1)
...
EVENTS: Dict[int, Dict[str, Union[Alert, Callable[[Any, messaging.SubMaster, bool], Alert]]]] = {
  ...
  EventName.startup: {
    ET.PERMANENT: Alert(
      _("Welcome to Openpilot"),
      _("To use Autosteer, press the lane-keep-assist button."),
      AlertStatus.normal, AlertSize.mid,
  ...
  # thrown when over 30% of frames are dropped.
